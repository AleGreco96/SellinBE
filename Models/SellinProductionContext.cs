...
namespace SellinBE.Models;

public partial class SellinProductionContext : DbContext
{
    public SellinProductionContext()
    {
    }

    public SellinProductionContext(DbContextOptions<SellinProductionContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=.\\sqlexpress;Initial Catalog=SellinProduction;Integrated Security=True;TrustServerCertificate=True;");
